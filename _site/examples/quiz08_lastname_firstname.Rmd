...
* Upload this Rmd file and the knitted output (.html) to moodle (20 points)

* This quiz assumes you have watched the videos had worked through the exercises in exercises_slides-50-61.Rmd


# Collaboration

* For this quiz I worked with: ??? 


```{r}
library(pacman) #load package manager
p_load(tidyverse, patchwork) #load packages
